...
void Game::calcRays()
{
	...
	for (int r = 0; r < numRays; r++)
	{
		...
		if (currentRayAngle > P2 && currentRayAngle < P3)//ray looking left
		{
			...
			currentRay.RayVector.Y = (player->Position.X - currentRay.RayVector.X) * nTan;
		...
		if (horizontal.Length() < vertical.Length())//hit horizontal wall
		{
